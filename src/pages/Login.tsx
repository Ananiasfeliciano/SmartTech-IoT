    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-tech-black p-4 text-white">
      ...
      >
        ...
        <div className="relative py-4">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-tech-gray px-2 text-white/30 font-medium">Acesso Restrito</span></div>
        </div>
        <div className="mb-5 grid grid-cols-2 gap-3 text-xs text-slate-300">
          <div className="rounded-lg border border-white/10 bg-white/3 p-3"><Wifi className="mb-2 h-4 w-4 text-blue-300" />Rede segura</div>
          <div className="rounded-lg border border-white/10 bg-white/3 p-3"><LockKeyhole className="mb-2 h-4 w-4 text-blue-300" />Admin OS</div>
        </div>
